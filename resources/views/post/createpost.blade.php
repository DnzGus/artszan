...
@csrf
    ...
    <div class="d-flex justify-content-center">
        <input type="file" name="images[]" multiple id="uploadBtn">
        <label id="uploadBtn2" for="uploadBtn"><i class="bi bi-upload"></i> Enviar Imagem</label>
    </div>
    ...
    <div class="d-flex justify-content-center">
        <button class="btn btn-primary fw-semibold" id="confirmar" href="#" role="button" type="submit">Confirmar</button>
    </div>
</form>
